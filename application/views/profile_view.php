...
<head>
  ...
  <?=link_tag('assets/profile_style.css');?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-sm-offset-6 poketdex-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 poketdex-tab-menu">
              <div class="list-group">
                <a href="/users/view_profile" class="list-group-item active text-center">
                ...
                <a href="/users/view_add_friend">
                  <div>
                    <a href="/users/view_add_friend" class="list-group-item text-center">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 poketdex-tab">
                <div class="poketdex-tab-content active">
                    <center class="left_text">
                      <img src="user_image.png" alt="Profile Image">
                      <h3 class="top-margin">Name: <?= $name ?></h3>
                      <h3 class="top-margin">Username: <?= $username ?></h3>
                      <h3 class="top-margin">Birthday: <?= $birthday ?></h3>
                      <h3 class="top-margin">About Me:</h3>
                      <form action="/users/add_about_me" method="post">
                        <label>
                          <textarea name="about_me" placeholder="Write about yourself"><?php 
                                  if (empty($about_me)) {
                                    foreach ($content as $content) {
                                      echo $content['about_user'];
                                    }
