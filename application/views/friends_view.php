            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 poketdex-tab">
                <div class="poketdex-tab-content active">
                    <center class="left_text">
                      ...
                      <h3 style="margin-top: 0;color:#55518a">Name:</h3>
                      <h3 style="margin-top: 0;color:#55518a">Username:</h3>
                      <h3 style="margin-top: 0;color:#55518a">Birthday:</h3>
                      <h3 style="margin-top: 0;color:#55518a">About Me:</h3>
                      <form action="" method="post">
                        <label>
                          <textarea name="about_me" placeholder="Write about yourself"></textarea>
                        </label>
