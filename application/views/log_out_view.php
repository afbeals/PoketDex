...
<head>
  ...
  <?=link_tag('assets/log_out_style.css');?>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 poketdex-tab">
                <div class="poketdex-tab-content active">
                    <center class="center_text">
                      <h1 class="top-margin">Are you sure you'd like to log out?:</h1>
                      <h4 class="top-margin2">(You won't be able to catch pokemon until you log back in)</h4>
                      <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 top-margin2">
                        <a href="/users/log_off">Log Out</a>
                      </div>
                    </center>
                </div>
            </div>
