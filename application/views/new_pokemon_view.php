...
<head>
  ...
  <?=link_tag('assets/new_pokemon_style.css');?>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 poketdex-tab">
                <div class="poketdex-tab-content active">
                    <center class="left_text">
                      <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 col-sm-offset-2">
                        <img  src="" alt="Profile Image">
                      </div>
                      <div class="col-sm-12">
                        <h3 class="top-margin">Name: </h3>
                        <h3 class="top-margin">Type: </h3>
                        <h3 class="top-margin">Location: </h3>
                        <h3 class="top-margin">Rareity: </h3>
                      </div>
                      <form  action="" method="post">
                        <input class="top-margin" type="hidden" name="catch" />
                        <input class="col-sm-4 col-sm-offset-4 top-margin" type="submit" value="Catch" />
                      </form>
                      <form action="" method="post">
                        <input class="top-margin" type="hidden" name="ignore" />
                        <input class="col-sm-4 col-sm-offset-4 top-margin" type="submit" value="ignore" />
                      </form>
                    </center>
                </div>
            </div>
